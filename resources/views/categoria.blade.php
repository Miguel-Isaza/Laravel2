        ...
        <tbody>
            @foreach ($categorias as $categoria)
                <tr>
                    ...
                    <td><a href="{{ route('editCategoria.view', $categoria->id) }}" class="btn">Editar</a></td>
                    <td><a href="{{ route('deleteCategoria', $categoria->id) }}" class="btn-delete">Borrar</a>
                    </td>
