...
<body>
    ...
    <form action="{{route('add.product')}}" method="POST">
        ...
        <select name="id_proveedor" id="">
            <option value="" disabled selected>Selecciona un proevedor</option>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{route('editProduct.view', $producto->id)}}"class="btn">Editar</a>
                </td>
                <td><a href="{{route('deleteProduct', $producto->id)}}"class="btn-delete">Borrar</a></td>
